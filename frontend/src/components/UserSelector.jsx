...
export default function UserSelector() {
  const { currentUser, login, register, loginWithGoogle, loading } = useUser();
      ...
      <div className="bg-black/40 backdrop-blur-xl rounded-3xl p-8 max-w-md w-full mx-4 border border-purple-500/20 shadow-2xl">
        <div className="text-center mb-6">
          ...
          <p className="text-white/60">
            {mode === 'login' ? 'Sign in to start the party' : 'Create your account'}
          </p>
        </div>
        ...
        {mode === 'login' ? (
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              <label htmlFor="reg-email" className="block text-sm font-medium text-white/80 mb-1">
                Email
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="reg-confirm-password" className="block text-sm font-medium text-white/80 mb-1">
                Confirm Password
              </label>
              <input
                type="password"
