      ...
      <div className="p-3 flex items-center gap-3">
        ...
        >
          <div className="flex-1 min-w-0">
            {selectedPlaylist ? (
              <>
                <p className={`font-medium text-sm truncate ${isBroadcasting ? 'text-green-400' : 'text-white'}`}>
                  {selectedPlaylist.name}
                </p>
                <p className={`text-xs ${isBroadcasting ? 'text-green-300/60' : 'text-purple-300/60'}`}>
                  ...
                  {isBroadcasting && <span className="ml-1">· {viewerCount ?? 0} viewers</span>}
                </p>
              </>
            ) : (
              <>
          ...
          <svg className="w-4 h-4 text-purple-300/50 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {/* View broadcast icon - only when broadcasting */}
        {isBroadcasting && (
          <button
